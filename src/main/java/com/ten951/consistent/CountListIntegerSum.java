...
/**
 * @author Darcy
 * Created By Darcy on 2019-05-08 16:44
 */
    ...
    public class SubIntegerSumTask implements Runnable {
        ...
        public void run() {
            ...
            try {
                ...
                System.out.println(Thread.currentThread().getName() + ":BrokenBarier");
            }
...
//生成的List数据
        ...
        System.out.println("List中所有整数的和为:" + sum + " " + (System.currentTimeMillis() - l));
        final long l1 = System.currentTimeMillis();
        final OptionalLong reduce = list.stream().mapToLong(Integer::longValue).reduce(Long::sum);
        System.out.println("reduce = " + reduce.orElse(0L) + " " + (System.currentTimeMillis() - l1));
